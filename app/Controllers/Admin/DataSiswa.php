...
class DataSiswa extends BaseController
{
   ...
   public function index()
   {
      ...
      return view('admin/data/data-peserta', $data);
   }
   ...
   public function ambilDataSiswa()
   {
      ...
      return view('admin/data/list-data-peserta', $data);
   }
   ...
   public function formTambahSiswa()
   {
      ...
      return view('admin/data/create/create-data-peserta', $data);
   }
   ...
   public function formEditSiswa($id)
   {
      ...
      if (empty($siswa) || empty($kelas)) {
         throw new PageNotFoundException('Data Peserta dengan id ' . $id . ' tidak ditemukan');
      }
      ...
      return view('admin/data/edit/edit-data-peserta', $data);
   }
