        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-chart">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Tingkat kehadiran Peserta</h4>
                        <p class="card-category">Jumlah kehadiran peserta dalam 7 hari terakhir</p>
                    </div>
                    <div class="card-footer">
                        <div class="stats">
                            <i class="material-icons text-primary">checklist</i> <a class="text-primary" href="<?= base_url('admin/absen-peserta'); ?>">Lihat data</a>
                        </div>
                    </div>
                </div>
            </div>
